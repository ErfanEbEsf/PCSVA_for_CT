...
%% Proposed
cd('C:\Users\ebrahimesfahani\Desktop\5_Proposed_PCA')
...
%% WNNM
cd('C:\Users\ebrahimesfahani\Desktop\4_WNNM_2')
addpath(genpath('SAIST_Denoising_Erfan'))
tic;
[WNNM,Snr,Ssim] = ...
 Image_LASSC_Denoising_Erfan...
...
%% SAIST
cd('C:\Users\ebrahimesfahani\Desktop\3_SAIST')
addpath(genpath('SAIST_Denoising_Erfan'))
tic;
[SAIST,Snr,Ssim] = ...
 Image_LASSC_Denoising_Erfan...
...
%% BM3D
cd('C:\Users\ebrahimesfahani\Desktop\2_BM3D')
...
BM3d = u;
%% TGV
cd('C:\Users\ebrahimesfahani\Desktop\1_TGV')
addpath(genpath('./UTILS'));
tic;
[TGV] = TGV_den(y);
...
%% Classical PCA
cd('C:\Users\ebrahimesfahani\Desktop\6_classical_PCA')
addpath(genpath('SAIST_Denoising_Erfan'))
tic;
[PCA,Snr,Ssim] = ...
 Image_LASSC_Denoising_Erfan...
...
Delta = 50;
x1 = 80; x2 = x1 + Delta; %70 %120
y1 = 40; y2 = y1 + Delta; %78 %117 
Op = 0;
FS = 16;
