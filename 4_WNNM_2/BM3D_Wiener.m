function [PSNR, y_est] = BM3D_Wiener(y, z, sigma, profile, print_to_screen)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
y = single(y);
tic;
y_est = bm3d_wiener(z, y, hadper_trans_single_den, Nstep_wiener, N1_wiener, N2_wiener, ...
...
% Commented by Erfan for convinience
% if dump_output_information == 1,
